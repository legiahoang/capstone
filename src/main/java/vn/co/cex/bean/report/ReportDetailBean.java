...
public class ReportDetailBean extends BaseBean {
	...
	private static final Logger log = LogManager.getLogger(ReportDetailBean.class);
	...
	public void addNewReport() {
		try {
			...
			Report report = new Report(userId, new Date(), reportTitle, reportQuestion, reportSolution, reportContent,
					true);
