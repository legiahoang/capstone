...
public class UsersDetailBean extends BaseBean {
	...
	private String fileIdentityCardImg;
	private String provinceName;
	private String districtName;
	private String provinceCode;
	
	
	public String getFileIdentityCardImg() {
		return fileIdentityCardImg;
	}

	public void setFileIdentityCardImg(String fileIdentityCardImg) {
		this.fileIdentityCardImg = fileIdentityCardImg;
	}
	...
	public void init() {
		try {
			...
			fileIdentityCardImg = user.getIdentityCardImage();
		} catch (Exception e) {
			log.error(e);
		}
	}
